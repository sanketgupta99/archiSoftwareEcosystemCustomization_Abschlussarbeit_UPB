...
public class ArchimatePackage extends EPackageImpl implements IArchimatePackage {
	 ...
	 * @generated
	 */
	private EClass revenueGenerationSystemEClass = null;
	 ...
	 * @generated
	 */
	private EClass thirdPartyProviderEClass = null;
	 ...
	 * @generated
	 */
	private EClass reviewingEClass = null;
	 ...
	 * @generated
	 */
	private EClass opennessEClass = null;
	 ...
	 * @generated
	 */
	private EClass technologicalBoundaryResourcesEClass = null;
	 ...
	 * @generated
	 */
	private EClass socialBoundaryResourcesEClass = null;
	 ...
	 */
	@Override
	public EClass getRevenueGenerationSystem() {
		return revenueGenerationSystemEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getRevenueGenerationSystem_EntranceFee() {
		return (EAttribute)revenueGenerationSystemEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getRevenueGenerationSystem_ServiceFee() {
		return (EAttribute)revenueGenerationSystemEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getRevenueGenerationSystem_PlatformFee() {
		return (EAttribute)revenueGenerationSystemEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getRevenueGenerationSystem_Donation() {
		return (EAttribute)revenueGenerationSystemEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EClass getThirdPartyProvider() {
		return thirdPartyProviderEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getThirdPartyProvider_Category() {
		return (EAttribute)thirdPartyProviderEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getReviewing() {
		return reviewingEClass;
	}
	 ...
	 */
	@Override
	public EClass getOpenness() {
		return opennessEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getOpenness_Openness() {
		return (EAttribute)opennessEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getTechnologicalBoundaryResources() {
		return technologicalBoundaryResourcesEClass;
	}
	 ...
	 */
	@Override
	public EClass getSocialBoundaryResources() {
		return socialBoundaryResourcesEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getContext_DomainCrticality() {
	 ...
	 */
	@Override
	public EAttribute getContext_Commercialization() {
	 ...
	 */
	@Override
	public EAttribute getContext_TargetMarket() {
    ...
    public void createPackageContents() {
		...
		revenueGenerationSystemEClass = createEClass(REVENUE_GENERATION_SYSTEM);
		createEAttribute(revenueGenerationSystemEClass, REVENUE_GENERATION_SYSTEM__ENTRANCE_FEE);
		createEAttribute(revenueGenerationSystemEClass, REVENUE_GENERATION_SYSTEM__SERVICE_FEE);
		createEAttribute(revenueGenerationSystemEClass, REVENUE_GENERATION_SYSTEM__PLATFORM_FEE);
		createEAttribute(revenueGenerationSystemEClass, REVENUE_GENERATION_SYSTEM__DONATION);

		thirdPartyProviderEClass = createEClass(THIRD_PARTY_PROVIDER);
		createEAttribute(thirdPartyProviderEClass, THIRD_PARTY_PROVIDER__CATEGORY);
		...
		reviewingEClass = createEClass(REVIEWING);

		opennessEClass = createEClass(OPENNESS);
		createEAttribute(opennessEClass, OPENNESS__OPENNESS);

		technologicalBoundaryResourcesEClass = createEClass(TECHNOLOGICAL_BOUNDARY_RESOURCES);

		socialBoundaryResourcesEClass = createEClass(SOCIAL_BOUNDARY_RESOURCES);

		contextEClass = createEClass(CONTEXT);
		createEAttribute(contextEClass, CONTEXT__DOMAIN_CRTICALITY);
		createEAttribute(contextEClass, CONTEXT__COMMERCIALIZATION);
		createEAttribute(contextEClass, CONTEXT__TARGET_MARKET);
    ...
    public void initializePackageContents() {
		...
		revenueGenerationSystemEClass.getESuperTypes().add(this.getBusinessProcess());
		thirdPartyProviderEClass.getESuperTypes().add(this.getBusinessActor());
		storeEClass.getESuperTypes().add(this.getApplicationComponent());
		platformEClass.getESuperTypes().add(this.getSystemSoftware());
		ratingEClass.getESuperTypes().add(this.getApplicationProcess());
		rankingEClass.getESuperTypes().add(this.getApplicationProcess());
		reviewingEClass.getESuperTypes().add(this.getApplicationProcess());
		opennessEClass.getESuperTypes().add(this.getConstraint());
		technologicalBoundaryResourcesEClass.getESuperTypes().add(this.getResource());
		socialBoundaryResourcesEClass.getESuperTypes().add(this.getResource());
		contextEClass.getESuperTypes().add(this.getImplementationMigrationElement());
		contextEClass.getESuperTypes().add(this.getBehaviorElement());
		...
		initEClass(revenueGenerationSystemEClass, IRevenueGenerationSystem.class, "RevenueGenerationSystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getRevenueGenerationSystem_EntranceFee(), ecorePackage.getEBoolean(), "entranceFee", "false", 0, 1, IRevenueGenerationSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		initEAttribute(getRevenueGenerationSystem_ServiceFee(), ecorePackage.getEBoolean(), "serviceFee", "false", 0, 1, IRevenueGenerationSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		initEAttribute(getRevenueGenerationSystem_PlatformFee(), ecorePackage.getEBoolean(), "platformFee", "false", 0, 1, IRevenueGenerationSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		initEAttribute(getRevenueGenerationSystem_Donation(), ecorePackage.getEBoolean(), "donation", "false", 0, 1, IRevenueGenerationSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$

		initEClass(thirdPartyProviderEClass, IThirdPartyProvider.class, "ThirdPartyProvider", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getThirdPartyProvider_Category(), ecorePackage.getEString(), "category", "Trusted Partner", 0, 1, IThirdPartyProvider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$

		initEClass(storeEClass, IStore.class, "Store", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(platformEClass, IPlatform.class, "Platform", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getPlatform_Type(), ecorePackage.getEString(), "type", "Operating System", 0, 1, IPlatform.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$

		initEClass(ratingEClass, IRating.class, "Rating", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(rankingEClass, IRanking.class, "Ranking", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(reviewingEClass, IReviewing.class, "Reviewing", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(opennessEClass, IOpenness.class, "Openness", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getOpenness_Openness(), ecorePackage.getEString(), "openness", "Close", 0, 1, IOpenness.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$

		initEClass(technologicalBoundaryResourcesEClass, ITechnologicalBoundaryResources.class, "TechnologicalBoundaryResources", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(socialBoundaryResourcesEClass, ISocialBoundaryResources.class, "SocialBoundaryResources", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(contextEClass, IContext.class, "Context", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getContext_DomainCrticality(), ecorePackage.getEBoolean(), "domainCrticality", null, 0, 1, IContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getContext_Commercialization(), ecorePackage.getEBoolean(), "commercialization", null, 0, 1, IContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getContext_TargetMarket(), ecorePackage.getEString(), "targetMarket", null, 0, 1, IContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
