...
public class ArchimateFactory extends EFactoryImpl implements IArchimateFactory {
    ...
    public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case IArchimatePackage.REVENUE_GENERATION_SYSTEM: return createRevenueGenerationSystem();
			case IArchimatePackage.THIRD_PARTY_PROVIDER: return createThirdPartyProvider();
			case IArchimatePackage.STORE: return createStore();
			case IArchimatePackage.PLATFORM: return createPlatform();
			case IArchimatePackage.RATING: return createRating();
			case IArchimatePackage.RANKING: return createRanking();
			case IArchimatePackage.REVIEWING: return createReviewing();
			case IArchimatePackage.OPENNESS: return createOpenness();
			case IArchimatePackage.TECHNOLOGICAL_BOUNDARY_RESOURCES: return createTechnologicalBoundaryResources();
			case IArchimatePackage.SOCIAL_BOUNDARY_RESOURCES: return createSocialBoundaryResources();
			case IArchimatePackage.CONTEXT: return createContext();
			default:
	 ...
	 */
	@Override
	public IRevenueGenerationSystem createRevenueGenerationSystem() {
		RevenueGenerationSystem revenueGenerationSystem = new RevenueGenerationSystem();
	 ...
	 */
	@Override
	public IThirdPartyProvider createThirdPartyProvider() {
	 ...
	 */
	@Override
	public IReviewing createReviewing() {
	 ...
	 */
	@Override
	public IOpenness createOpenness() {
	 ...
	 */
	@Override
	public ITechnologicalBoundaryResources createTechnologicalBoundaryResources() {
		TechnologicalBoundaryResources technologicalBoundaryResources = new TechnologicalBoundaryResources();
		return technologicalBoundaryResources;
	}
	 ...
	 */
	@Override
	public ISocialBoundaryResources createSocialBoundaryResources() {
		SocialBoundaryResources socialBoundaryResources = new SocialBoundaryResources();
		return socialBoundaryResources;
	}
