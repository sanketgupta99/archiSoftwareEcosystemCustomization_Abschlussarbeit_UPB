...
public class ArchimateModelUtils {
    ...
    public static EClass[] getStrategyClasses() {
        return new EClass[] {
                ...
                IArchimatePackage.eINSTANCE.getTechnologicalBoundaryResources(),
                IArchimatePackage.eINSTANCE.getSocialBoundaryResources()
        };
    }
    ...
    public static EClass[] getBusinessClasses() {
        return new EClass[] {
                ...
                IArchimatePackage.eINSTANCE.getRevenueGenerationSystem(),
                IArchimatePackage.eINSTANCE.getThirdPartyProvider()
        };
    }
    ...
    public static EClass[] getApplicationClasses() {
        return new EClass[] {
                ...
                IArchimatePackage.eINSTANCE.getStore(),
                IArchimatePackage.eINSTANCE.getRating(),
                IArchimatePackage.eINSTANCE.getRanking(),
                IArchimatePackage.eINSTANCE.getReviewing()
        };
    }
    ...
    public static EClass[] getTechnologyClasses() {
        return new EClass[] {
                ...
                IArchimatePackage.eINSTANCE.getPlatform()
        };
    }
    ...
    public static EClass[] getMotivationClasses() {
        return new EClass[] {
                ...
                IArchimatePackage.eINSTANCE.getOpenness()
        };
    }
    ...
    public static EClass[] getImplementationMigrationClasses() {
        return new EClass[] {
                ...
                IArchimatePackage.eINSTANCE.getContext()
        };
    }
