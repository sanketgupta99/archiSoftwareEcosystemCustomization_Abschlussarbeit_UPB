...
import com.archimatetool.model.ISocialBoundaryResources;
...
public class ArchimateSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case IArchimatePackage.REVENUE_GENERATION_SYSTEM: {
				IRevenueGenerationSystem revenueGenerationSystem = (IRevenueGenerationSystem)theEObject;
				T result = caseRevenueGenerationSystem(revenueGenerationSystem);
				if (result == null) result = caseBusinessProcess(revenueGenerationSystem);
				if (result == null) result = caseBusinessElement(revenueGenerationSystem);
				if (result == null) result = caseBehaviorElement(revenueGenerationSystem);
				if (result == null) result = caseArchimateElement(revenueGenerationSystem);
				if (result == null) result = caseArchimateConcept(revenueGenerationSystem);
				if (result == null) result = caseArchimateModelObject(revenueGenerationSystem);
				if (result == null) result = caseCloneable(revenueGenerationSystem);
				if (result == null) result = caseDocumentable(revenueGenerationSystem);
				if (result == null) result = caseProperties(revenueGenerationSystem);
				if (result == null) result = caseAdapter(revenueGenerationSystem);
				if (result == null) result = caseNameable(revenueGenerationSystem);
				if (result == null) result = caseIdentifier(revenueGenerationSystem);
				if (result == null) result = caseFeatures(revenueGenerationSystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IArchimatePackage.THIRD_PARTY_PROVIDER: {
				IThirdPartyProvider thirdPartyProvider = (IThirdPartyProvider)theEObject;
				T result = caseThirdPartyProvider(thirdPartyProvider);
				if (result == null) result = caseBusinessActor(thirdPartyProvider);
				if (result == null) result = caseBusinessElement(thirdPartyProvider);
				if (result == null) result = caseActiveStructureElement(thirdPartyProvider);
				if (result == null) result = caseStructureElement(thirdPartyProvider);
				if (result == null) result = caseArchimateElement(thirdPartyProvider);
				if (result == null) result = caseArchimateConcept(thirdPartyProvider);
				if (result == null) result = caseArchimateModelObject(thirdPartyProvider);
				if (result == null) result = caseCloneable(thirdPartyProvider);
				if (result == null) result = caseDocumentable(thirdPartyProvider);
				if (result == null) result = caseProperties(thirdPartyProvider);
				if (result == null) result = caseAdapter(thirdPartyProvider);
				if (result == null) result = caseNameable(thirdPartyProvider);
				if (result == null) result = caseIdentifier(thirdPartyProvider);
				if (result == null) result = caseFeatures(thirdPartyProvider);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IArchimatePackage.STORE: {
				IStore store = (IStore)theEObject;
				T result = caseStore(store);
				if (result == null) result = caseApplicationComponent(store);
				if (result == null) result = caseApplicationElement(store);
				if (result == null) result = caseActiveStructureElement(store);
				if (result == null) result = caseStructureElement(store);
				if (result == null) result = caseArchimateElement(store);
				if (result == null) result = caseArchimateConcept(store);
				if (result == null) result = caseArchimateModelObject(store);
				if (result == null) result = caseCloneable(store);
				if (result == null) result = caseDocumentable(store);
				if (result == null) result = caseProperties(store);
				if (result == null) result = caseAdapter(store);
				if (result == null) result = caseNameable(store);
				if (result == null) result = caseIdentifier(store);
				if (result == null) result = caseFeatures(store);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IArchimatePackage.PLATFORM: {
				IPlatform platform = (IPlatform)theEObject;
				T result = casePlatform(platform);
				if (result == null) result = caseSystemSoftware(platform);
				if (result == null) result = caseTechnologyElement(platform);
				if (result == null) result = caseActiveStructureElement(platform);
				if (result == null) result = caseStructureElement(platform);
				if (result == null) result = caseArchimateElement(platform);
				if (result == null) result = caseArchimateConcept(platform);
				if (result == null) result = caseArchimateModelObject(platform);
				if (result == null) result = caseCloneable(platform);
				if (result == null) result = caseDocumentable(platform);
				if (result == null) result = caseProperties(platform);
				if (result == null) result = caseAdapter(platform);
				if (result == null) result = caseNameable(platform);
				if (result == null) result = caseIdentifier(platform);
				if (result == null) result = caseFeatures(platform);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IArchimatePackage.RATING: {
				IRating rating = (IRating)theEObject;
				T result = caseRating(rating);
				if (result == null) result = caseApplicationProcess(rating);
				if (result == null) result = caseApplicationElement(rating);
				if (result == null) result = caseBehaviorElement(rating);
				if (result == null) result = caseArchimateElement(rating);
				if (result == null) result = caseArchimateConcept(rating);
				if (result == null) result = caseArchimateModelObject(rating);
				if (result == null) result = caseCloneable(rating);
				if (result == null) result = caseDocumentable(rating);
				if (result == null) result = caseProperties(rating);
				if (result == null) result = caseAdapter(rating);
				if (result == null) result = caseNameable(rating);
				if (result == null) result = caseIdentifier(rating);
				if (result == null) result = caseFeatures(rating);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IArchimatePackage.RANKING: {
				IRanking ranking = (IRanking)theEObject;
				T result = caseRanking(ranking);
				if (result == null) result = caseApplicationProcess(ranking);
				if (result == null) result = caseApplicationElement(ranking);
				if (result == null) result = caseBehaviorElement(ranking);
				if (result == null) result = caseArchimateElement(ranking);
				if (result == null) result = caseArchimateConcept(ranking);
				if (result == null) result = caseArchimateModelObject(ranking);
				if (result == null) result = caseCloneable(ranking);
				if (result == null) result = caseDocumentable(ranking);
				if (result == null) result = caseProperties(ranking);
				if (result == null) result = caseAdapter(ranking);
				if (result == null) result = caseNameable(ranking);
				if (result == null) result = caseIdentifier(ranking);
				if (result == null) result = caseFeatures(ranking);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IArchimatePackage.REVIEWING: {
				IReviewing reviewing = (IReviewing)theEObject;
				T result = caseReviewing(reviewing);
				if (result == null) result = caseApplicationProcess(reviewing);
				if (result == null) result = caseApplicationElement(reviewing);
				if (result == null) result = caseBehaviorElement(reviewing);
				if (result == null) result = caseArchimateElement(reviewing);
				if (result == null) result = caseArchimateConcept(reviewing);
				if (result == null) result = caseArchimateModelObject(reviewing);
				if (result == null) result = caseCloneable(reviewing);
				if (result == null) result = caseDocumentable(reviewing);
				if (result == null) result = caseProperties(reviewing);
				if (result == null) result = caseAdapter(reviewing);
				if (result == null) result = caseNameable(reviewing);
				if (result == null) result = caseIdentifier(reviewing);
				if (result == null) result = caseFeatures(reviewing);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IArchimatePackage.OPENNESS: {
				IOpenness openness = (IOpenness)theEObject;
				T result = caseOpenness(openness);
				if (result == null) result = caseConstraint(openness);
				if (result == null) result = caseMotivationElement(openness);
				if (result == null) result = caseArchimateElement(openness);
				if (result == null) result = caseArchimateConcept(openness);
				if (result == null) result = caseArchimateModelObject(openness);
				if (result == null) result = caseCloneable(openness);
				if (result == null) result = caseDocumentable(openness);
				if (result == null) result = caseProperties(openness);
				if (result == null) result = caseAdapter(openness);
				if (result == null) result = caseNameable(openness);
				if (result == null) result = caseIdentifier(openness);
				if (result == null) result = caseFeatures(openness);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IArchimatePackage.TECHNOLOGICAL_BOUNDARY_RESOURCES: {
				ITechnologicalBoundaryResources technologicalBoundaryResources = (ITechnologicalBoundaryResources)theEObject;
				T result = caseTechnologicalBoundaryResources(technologicalBoundaryResources);
				if (result == null) result = caseResource(technologicalBoundaryResources);
				if (result == null) result = caseStrategyElement(technologicalBoundaryResources);
				if (result == null) result = caseStructureElement(technologicalBoundaryResources);
				if (result == null) result = caseArchimateElement(technologicalBoundaryResources);
				if (result == null) result = caseArchimateConcept(technologicalBoundaryResources);
				if (result == null) result = caseArchimateModelObject(technologicalBoundaryResources);
				if (result == null) result = caseCloneable(technologicalBoundaryResources);
				if (result == null) result = caseDocumentable(technologicalBoundaryResources);
				if (result == null) result = caseProperties(technologicalBoundaryResources);
				if (result == null) result = caseAdapter(technologicalBoundaryResources);
				if (result == null) result = caseNameable(technologicalBoundaryResources);
				if (result == null) result = caseIdentifier(technologicalBoundaryResources);
				if (result == null) result = caseFeatures(technologicalBoundaryResources);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IArchimatePackage.SOCIAL_BOUNDARY_RESOURCES: {
				ISocialBoundaryResources socialBoundaryResources = (ISocialBoundaryResources)theEObject;
				T result = caseSocialBoundaryResources(socialBoundaryResources);
				if (result == null) result = caseResource(socialBoundaryResources);
				if (result == null) result = caseStrategyElement(socialBoundaryResources);
				if (result == null) result = caseStructureElement(socialBoundaryResources);
				if (result == null) result = caseArchimateElement(socialBoundaryResources);
				if (result == null) result = caseArchimateConcept(socialBoundaryResources);
				if (result == null) result = caseArchimateModelObject(socialBoundaryResources);
				if (result == null) result = caseCloneable(socialBoundaryResources);
				if (result == null) result = caseDocumentable(socialBoundaryResources);
				if (result == null) result = caseProperties(socialBoundaryResources);
				if (result == null) result = caseAdapter(socialBoundaryResources);
				if (result == null) result = caseNameable(socialBoundaryResources);
				if (result == null) result = caseIdentifier(socialBoundaryResources);
				if (result == null) result = caseFeatures(socialBoundaryResources);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IArchimatePackage.CONTEXT: {
				IContext context = (IContext)theEObject;
				T result = caseContext(context);
				if (result == null) result = caseImplementationMigrationElement(context);
				if (result == null) result = caseBehaviorElement(context);
				if (result == null) result = caseArchimateElement(context);
				if (result == null) result = caseArchimateConcept(context);
				if (result == null) result = caseArchimateModelObject(context);
				if (result == null) result = caseCloneable(context);
				if (result == null) result = caseDocumentable(context);
				if (result == null) result = caseProperties(context);
				if (result == null) result = caseAdapter(context);
				if (result == null) result = caseNameable(context);
				if (result == null) result = caseIdentifier(context);
				if (result == null) result = caseFeatures(context);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
    ...
    /**
	 * Returns the result of interpreting the object as an instance of '<em>Revenue Generation System</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Revenue Generation System</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRevenueGenerationSystem(IRevenueGenerationSystem object) {
		return null;
	}

				/**
	 * Returns the result of interpreting the object as an instance of '<em>Third Party Provider</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Third Party Provider</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseThirdPartyProvider(IThirdPartyProvider object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseStore(IStore object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePlatform(IPlatform object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRating(IRating object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRanking(IRanking object) {
		return null;
	}

				/**
	 * Returns the result of interpreting the object as an instance of '<em>Reviewing</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Reviewing</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReviewing(IReviewing object) {
		return null;
	}

				/**
	 * Returns the result of interpreting the object as an instance of '<em>Openness</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Openness</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOpenness(IOpenness object) {
		return null;
	}

				/**
	 * Returns the result of interpreting the object as an instance of '<em>Technological Boundary Resources</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Technological Boundary Resources</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTechnologicalBoundaryResources(ITechnologicalBoundaryResources object) {
		return null;
	}

				/**
	 * Returns the result of interpreting the object as an instance of '<em>Social Boundary Resources</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Social Boundary Resources</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSocialBoundaryResources(ISocialBoundaryResources object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseContext(IContext object) {
		return null;
	}
