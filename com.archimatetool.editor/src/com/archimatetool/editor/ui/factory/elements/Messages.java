...
public class Messages extends NLS {
    ...
    public static String RevenueGenerationSystemUIProvider_0;
    public static String ThirdPartyProviderUIProvider_0;
    public static String StoreUIProvider_0;
    public static String PlatformUIProvider_0;
    public static String RatingUIProvider_0;
    public static String RankingUIProvider_0;
    public static String ReviewingUIProvider_0;
    public static String ContextUIProvider_0;
    public static String OpennessUIProvider_0;
    public static String TechnologicalBoundaryResourcesUIProvider_0;
    public static String SocialBoundaryResourcesUIProvider_0;
