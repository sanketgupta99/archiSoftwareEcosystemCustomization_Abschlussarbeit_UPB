...
public interface IArchiImages {
    ...
    //Software ecosystem domain-specific elements
    String ICON_REVENUE_GENERATION_SYSTEM = ARCHIMATE_IMGPATH + "revenue.png"; //$NON-NLS-1$
    String ICON_THIRD_PARTY_PROVIDER = ARCHIMATE_IMGPATH + "external-developers.png"; //$NON-NLS-1$
    String ICON_STORE = ARCHIMATE_IMGPATH + "store.png"; //$NON-NLS-1$
    String ICON_PLATFORM = ARCHIMATE_IMGPATH + "platform.png"; //$NON-NLS-1$
    String ICON_RATING = ARCHIMATE_IMGPATH + "rating.png"; //$NON-NLS-1$
    String ICON_RANKING = ARCHIMATE_IMGPATH + "ranking.png"; //$NON-NLS-1$
    String ICON_REVIEWING = ARCHIMATE_IMGPATH + "reviewing.png"; //$NON-NLS-1$
    String ICON_CONTEXT = ARCHIMATE_IMGPATH + "context.png"; //$NON-NLS-1$
    String ICON_OPENNESS = ARCHIMATE_IMGPATH + "openness.png"; //$NON-NLS-1$
    String ICON_TECHNOLOGICAL_BOUNDARY_RESOURCES = ARCHIMATE_IMGPATH + "technological-boundary-resources.png"; //$NON-NLS-1$
    String ICON_SOCIAL_BOUNDARY_RESOURCES = ARCHIMATE_IMGPATH + "social-boundary-resources.png"; //$NON-NLS-1$
