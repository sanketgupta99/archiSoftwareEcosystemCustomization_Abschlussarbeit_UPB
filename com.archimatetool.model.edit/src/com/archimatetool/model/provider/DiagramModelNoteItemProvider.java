...
/**
 * This is the item provider adapter for a {@link com.archimatetool.model.IDiagramModelNote} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramModelNoteItemProvider extends DiagramModelObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DiagramModelNoteItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextContent_content_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_TextContent_content_feature", "_UI_TextContent_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 IArchimatePackage.Literals.TEXT_CONTENT__CONTENT,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns DiagramModelNote.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DiagramModelNote")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((IDiagramModelNote)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DiagramModelNote_type") : //$NON-NLS-1$
			getString("_UI_DiagramModelNote_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IDiagramModelNote.class)) {
