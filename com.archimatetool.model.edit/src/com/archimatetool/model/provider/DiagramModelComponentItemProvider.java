...
/**
 * This is the item provider adapter for a {@link com.archimatetool.model.IDiagramModelComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramModelComponentItemProvider 
	 ...
	 * @generated
	 */
	public DiagramModelComponentItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((IDiagramModelComponent)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DiagramModelComponent_type") : //$NON-NLS-1$
			getString("_UI_DiagramModelComponent_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IDiagramModelComponent.class)) {
