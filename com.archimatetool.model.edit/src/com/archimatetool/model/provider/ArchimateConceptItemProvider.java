...
/**
 * This is the item provider adapter for a {@link com.archimatetool.model.IArchimateConcept} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchimateConceptItemProvider 
	 ...
	 * @generated
	 */
	public ArchimateConceptItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((IArchimateConcept)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ArchimateConcept_type") : //$NON-NLS-1$
			getString("_UI_ArchimateConcept_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IArchimateConcept.class)) {
