 ...
 * @generated
 */
public class ConstraintTest extends ArchimateElementTest {
	 ...
	 */
	@Override
	protected IConstraint getFixture() {
		return (IConstraint)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(IArchimateFactory.eINSTANCE.createConstraint());
	}
