 ...
 * @generated
 */
public class JunctionTest extends ArchimateElementTest {
	 ...
	 */
	@Override
	protected IJunction getFixture() {
		return (IJunction)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(IArchimateFactory.eINSTANCE.createJunction());
	}
