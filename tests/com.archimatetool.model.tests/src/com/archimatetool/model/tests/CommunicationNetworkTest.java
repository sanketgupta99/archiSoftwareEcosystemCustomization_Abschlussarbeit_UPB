 ...
 * @generated
 */
public class CommunicationNetworkTest extends ArchimateElementTest {
	 ...
	 */
	@Override
	protected ICommunicationNetwork getFixture() {
		return (ICommunicationNetwork)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(IArchimateFactory.eINSTANCE.createCommunicationNetwork());
	}
