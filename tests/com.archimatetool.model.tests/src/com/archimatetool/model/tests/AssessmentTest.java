 ...
 * @generated
 */
public class AssessmentTest extends ArchimateElementTest {
	 ...
	 */
	@Override
	protected IAssessment getFixture() {
		return (IAssessment)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(IArchimateFactory.eINSTANCE.createAssessment());
	}
