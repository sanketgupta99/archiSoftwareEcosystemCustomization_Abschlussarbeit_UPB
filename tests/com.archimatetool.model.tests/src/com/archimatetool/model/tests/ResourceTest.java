 ...
 * @generated
 */
public class ResourceTest extends ArchimateElementTest {
	 ...
	 */
	@Override
	protected IResource getFixture() {
		return (IResource)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(IArchimateFactory.eINSTANCE.createResource());
	}
