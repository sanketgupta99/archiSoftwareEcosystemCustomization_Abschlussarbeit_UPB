...
import com.archimatetool.model.provider.ArchimateItemProviderAdapterFactory;
...
/**
 * This is an example of a Archimate model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchimateEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(ArchimateModelWizard.FILE_EXTENSIONS, "*."); //$NON-NLS-1$
			...
			public void partActivated(IWorkbenchPart p) {
				if (p instanceof ContentOutline) {
					if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
						getActionBarContributor().setActiveEditor(ArchimateEditor.this);
				...
				else if (p == ArchimateEditor.this) {
					handleActivate();
				}
			}
			@Override
	...
	protected void handleActivate() {
		...
		if (!removedResources.isEmpty()) {
			if (handleDirtyConflict()) {
				getSite().getPage().closeEditor(ArchimateEditor.this, false);
			}
			else {
	...
	protected void updateProblemIndication() {
		if (updateProblemIndication) {
			BasicDiagnostic diagnostic =
				new BasicDiagnostic
					(Diagnostic.OK,
					 "com.archimatetool.editor2", //$NON-NLS-1$
					 0,
					 null,
	...
	protected void initializeEditingDomain() {
		...
		adapterFactory.addAdapterFactory(new ArchimateItemProviderAdapterFactory());
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				ViewerPane viewerPane =
					new ViewerPane(getSite().getPage(), ArchimateEditor.this) {
						@Override
		...
		PropertySheetPage propertySheetPage =
			new ExtendedPropertySheetPage(editingDomain, ExtendedPropertySheetPage.Decoration.NONE, null, 0, false) {
				...
				public void setSelectionToViewer(List<?> selection) {
					ArchimateEditor.this.setSelectionToViewer(selection);
					ArchimateEditor.this.setFocus();
				}
	...
	public void doSaveAs() {
		...
		String[] files = ArchimateEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
	...
	private static String getString(String key) {
		return ArchimateEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return ArchimateEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
